...
public class MainActivity extends FragmentActivity implements DownloadCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // so you can omit collector e screenshot url

        Instrumentation.start(AgentConfiguration.builder()
                .withAppKey("<<app-key>>")
                .withContext(getApplicationContext())
                .withCollectorURL("https://pdx-col.eum-appdynamics.com")
                .withScreenshotURL("https://pdx-col-image.eum-appdynamics.com/")
                .withLoggingEnabled(true)
                .withLoggingLevel(Instrumentation.LOGGING_LEVEL_VERBOSE)
                .withJSAgentInjectionEnabled(true)
                .withJSAgentAjaxEnabled(true)
                .build());

        setContentView(R.layout.sample_main);
        mDataText = (TextView) findViewById(R.id.data_text);
        mNetworkFragment = NetworkFragment.getInstance(getSupportFragmentManager(), "https://parallelum.com.br/fipe/api/v1/carros/marcas");
        ...
        */
        ...
        Log.i("appdynamics","---------- agente started");
